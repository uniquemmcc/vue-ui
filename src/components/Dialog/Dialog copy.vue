<template>
    <div class="dialog" ref="outer" :style="{width,height,transform}">
       
            <div class="dialog-title" @mousedown="mousedown_t" @touchstart="mousedown_t">
                title
            </div>
            <div class="dialog-content">
               <!-- <render-dom  :renderFunction="render" :data="{content:'content'}"></render-dom> -->
            </div>   
            <div class="dialog-tigger-right" @mousedown="mousedown_r"  @touchstart="mousedown_r"></div>
            <div class="dialog-tigger-bottom" @mousedown="mousedown_b"  @touchstart="mousedown_b"></div>
            <div class="dialog-tigger-rightbottom" @mousedown="mousedown_rb"  @touchstart="mousedown_rb"></div>
    </div>
</template>
<script>
